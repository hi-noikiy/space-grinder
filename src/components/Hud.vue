<template>
    <div class='columns col-online hud'>
      ...
      <div title="Charge Capacity" class='column col-2'>{{this.$store.state.coulombs | exponentialize}}/{{capacity | exponentialize}} C</div>
      <div title="Energy" class='column col-2'>{{joules | exponentialize}} J</div>
